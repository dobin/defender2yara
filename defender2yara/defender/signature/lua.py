...
class LuaSig(BaseSig):
    def __init__(self,data:bytes,ptr:int=0) -> None:
        ...
        try:
            ...
            self.threat_name = self.raw_threat_name.decode('utf-8', errors='ignore')
